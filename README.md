...
### 介绍
- iOS objective-C生态系统管理列表。
- 这里是整理总结各种学习资料，iOS开发 非常全的三方库、插件、大牛博客等等
- 谢谢各位大神的贡献。

### 使用

- 搜索 <kbd>command</kbd> + <kbd>F</kbd> + <kbd>"名称"</kbd>

### Feedback

期待大家一起共同维护，请广大网友只按照目录结构（即使目录结构有问题）添加三方库，并提交pull request。
...
* [ADo_GuideView](https://github.com/Nododo/ADo_GuideView) - 转动的用户引导页(模仿网易bobo) 因为没有从app包里抓到3x的图片,建议在iPhone5模拟器运行,保证效果~ （版本新特性、导航页、引导页）.
...
* [iOS国际化开发](https://www.jianshu.com/p/7cb0fad6d06f) - 国际化开发
...
* [仿淘宝闲鱼的TabBar](https://github.com/NoCodeNoWife/LLRiseTabBar-iOS) - 仿淘宝闲鱼的TabBar.
...
* [KJBannerView](https://github.com/yangKJ/KJBannerViewDemo) - 支持缩放轮播Banner，自带图片下载、缓存相关功能,无任何第三方依赖、轻量级组件
* [YJBannerView](https://github.com/stackhou/YJBannerView.git) - 轻量级高性能轮播Banner组件，使用方法简单，可高度自定义化，超级赞
* [iCarousel](https://github.com/nicklockwood/iCarousel) - 实现旋转木马视图切换效果的第三方控件, 并提供多种切换效果。是一个使用简单、高度自定义的多类型视图切换的控件
...
* [Onboard](https://github.com/mamaral/Onboard) - 一个iOS框架，轻松创建一个美丽和吸引人的使用引导
...
* [NVActivityIndicatorView](https://github.com/ninjaprox/NVActivityIndicatorView) - loading 进度条动画，有20-30多种
...
* [ZFProgressView](https://github.com/WZF-Fei/ZFProgressView) - 使用GCD定时器代替NSTimer,避免内存泄露问题
* [WaveLoadingView](https://github.com/liuzhiyi1992/WaveLoadingView) - iOS 唯一完美的波浪进度加载指示器
* JustinFincher/JZMultiChoicesCircleButton) - 三维多选按钮.
...
* [KJEmitterView](https://github.com/yangKJ/KJEmitterView)一些粒子效果星空粒子，下雪粒子，烟花粒子等等、扩展、好用的工具等等
...
* [iVersion](https://github.com/nicklockwood/iVersion) - 一个灵活动态监测App是否有更新的库，并可以通知用户升级.
...
* [RestKit](https://github.com/RestKit/RestKit) - RestKit是一款专为iOS设计的Objective-C框架，旨在与RESTful web服务的交互变得更简单快速。它基于强大的对象映射系统，并且结合了一个干净、简单的HTTP请求/响应API，大大减少了完成任务所需的代码量。 
* [Moya](https://github.com/Moya/Moya) - Network abstraction layer written in Swift.
* [HYBNetworking](https://github.com/CoderJackyHuang/HYBNetworking) - 基于AFN封装的网络库，可以通用。
...
* [MMWormhole](https://github.com/mutualmobile/MMWormhole) - 2个iOS设备之间通信。
...
* [LxFTPRequest](https://github.com/DeveloperLx/LxFTPRequest) - 支持获取FTP服务器资源列表，下载/上传文件，创建/销毁ftp服务器文件/目录，以及下载断点续传，下载/上传进度，自动判断地址格式合法性跟踪等功能
...
* [JSQMessagesViewController](https://github.com/jessesquires/JSQMessagesViewController) - 聊天界面框架.
...
* [Cereal](https://github.com/Weebly/Cereal) - 对象序列化三方库 
...
* [realm-cocoa](https://github.com/realm/realm-cocoa) - 一个号称要代替Core Data & SQLite的用于移动端的数据库
...
* [SQLCipher](https://github.com/sqlcipher/sqlcipher) - SQLCipher使用256-bit AES加密，SQLCipher分为收费版本和免费版本。[官方教程](https://www.zetetic.net/sqlcipher/ios-tutorial/)， [加密你的SQLite](http://foggry.com/blog/2014/05/19/jia-mi-ni-de-sqlite/) - 各种sqlite数据库加密介绍。 
* [SQLCipherDemo下载](http://download.csdn.net/detail/wzzvictory_tjsd/7379055) 

#### 缓存处理

* [YYCache](https://github.com/ibireme/YYCache) - 高性能的 iOS 缓存框架.
* [YTKKeyValueStore](https://github.com/yuantiku/YTKKeyValueStore) - Key-Value存储工具类
...
* [高级动画技术](https://github.com/AttackOnDobby/iOS-Core-Animation-Advanced-Techniques) - 中文版iOS 高级动画技术.
* [核心动画](https://github.com/ZsIsMe/ios_core_animation_advanced_techniques) - 核心动画学习资料 [其中的核心动画电子书](https://zsisme.gitbooks.io/ios-/content/)
...
* [Cheetah](https://github.com/suguru/Cheetah) - 易用、高可读链式动画类库。另一个类似类库是 
...
* [STLBGVideo](https://github.com/StoneLeon/STLBGVideo) - STLBGVideo让您的视图控制器的自定义backgroundvideo,
...
* [全景视频播放器](https://github.com/NYTimes/ios-360-videos) - 基于AVPlayer的360度全景视频播放器.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) - 非常赞 B站开源的视频播放器，支持Android和iOS
...
* [MRVLCPlayer](https://github.com/Maru-zhang/MRVLCPlayer) - 相信Mac用户都很熟悉一款VLC播放器，这款播放器在Mac上表现异常优异，支持的格式几乎涵盖了所有格式（就是这么屌！）。没错，就是它创造者--VideoLAN，开源了一款牛逼的视频播放框架MobileVLCKit
...
* [MWPhotoBrowser](https://github.com/mwaterfall/MWPhotoBrowser) - 一个非常不错的照片浏览器
...
* [FastImageCache](https://github.com/path/FastImageCache) - 一个高效显示图片的库，支持图片缓存、平滑滚动和图片检索.
...
* [EGOCache](https://github.com/enormego/EGOCache) - 十分知名的第三方缓存类库，可以缓存NSString、UIImage、NSImage以及NSData。除此，如果还可以缓存任何一个实现了<NSCoding>接口的对象。所有缓存的数据都可以自定义过期的时间，默认是1天。EGOCache 支持多线程（thread-safe）
...
* [FlatUIKit](https://github.com/Grouper/FlatUIKit) - 针对Foundation的扩展
* [JKCategories](https://github.com/shaojiankui/JKCategories) - 分类集合，包含Foundation,UIKit,CoreData,QuartzCore,CoreLocation,MapKit Etc等等.
...
* [BFKit](https://github.com/FabrizioBrancati/BFKit) - 非常不错的分类集合工具库，大幅提高开发效率.同时包含Swift版本.
* [NullSafe](https://github.com/nicklockwood/NullSafe) - 用于防止项目中数组为空时越界访问崩溃.
...
* [DTFoundation](https://github.com/Cocoanetics/DTFoundation) - 标准工具类和分类
...
* [开源项目的徽章](http://shields.io/) - 开源项目的徽章.
...
* [JVFloatLabeledTextField](https://github.com/jverdi/JVFloatLabeledTextField) - UITextField 的子类, 主要实现输入框标签浮动效果
...
* [WordPress-Editor-iOS](https://github.com/wordpress-mobile/WordPress-Editor-iOS) - 文本编辑器 简书和新浪博客都在用.
...
* [CTTextDisplayView](https://github.com/BrownCN023/CTTextDisplayView) - CoreText完成的图文混排视图，主要用于文本中显示表情#URL等，类似于QQ、微博的评论图文功能
...
* [GCD](https://github.com/yangKJ/GCD) ios多线程 - GCDdemo
...
* [iOS7-Sampler](https://github.com/shu223/iOS7-Sampler) - 整合了iOS7.0的一些十分有用的特性，比如：Dynamic Behaviors、碰撞检测、语音合成、视图切换、图像滤镜、三维地图、Sprite Kit（动画精灵）、Motion Effect（Parallax）、附近蓝牙或者wifi搜索连接、AirDrop、运动物体追踪（iPhone 5S以上，需要M7处理器）等等。
...
博客地址 | RSS地址
----- | -----
[77__简书地址](https://www.jianshu.com/u/c84c00476ab6) | 77__简书地址
